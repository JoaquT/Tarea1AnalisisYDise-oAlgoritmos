...
\begin{algorithmic}[1]
  \Function{Multiplicacion}{x, y}   % <- IMPORTANTE: abrir de nuevo
...
\scriptsize % �� reducimos el tamaño de la letra
\begin{algorithm}[H]
\caption{Multiplicación de matrices por divide y vencerás(Parte I)}
\begin{algorithmic}[1]
  \Function{Mult\_Divide\_Conquer}{A, B}
...
\begin{algorithmic}[1]
  \Function{Mult\_Divide\_Conquer}{A, B}   % <- Reabrir función
